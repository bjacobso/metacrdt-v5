...
| Doc | What it is |
| --- | --- |
| [`triplex-coordination.md`](./triplex-coordination.md) | The new Triplex consumer: ownership boundaries, implemented requirement/collection lifecycle, recovery guarantees, and remaining migration work. Start here. |
...
**Suggested order for a newcomer:** [`triplex-coordination.md`](./triplex-coordination.md)
(current direction) → [`engine.md`](./engine.md) (existing implementation) →
[`protocol.md`](./protocol.md) (original convergence contract).
