...
| [`worldvm.md`](./worldvm.md)             | The clean WorldVM company pitch: virtual machine for organizational reality, homepage thesis, AI urgency, and relation to OntologyVM/MetaCRDT | naming        |
