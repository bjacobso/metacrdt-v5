...
| `@metacrdt/cloudflare` | IR → DO + SQLite triple store ([cloudflare-target.md](../plans/cloudflare-target.md)) | DO RPC methods | WebSocket push (stretch) |
...
[`../reference/targets.md`](../reference/targets.md)). Forma authored it once; it now runs
