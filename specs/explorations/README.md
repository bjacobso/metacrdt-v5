...
| [`schematics.md`](./schematics.md) | **Schematics under the MetaCRDT umbrella** — schema-routed markdown+Forma artifacts as the Terraform-like authoring, validation, `plan`/`apply`, and drift workbench for MetaCRDT blueprints. |
