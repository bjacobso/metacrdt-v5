...
> `🗄` Documents here are **frozen**. They are no longer the source of truth, but
> are retained because they explain *why* the current structure is the way it is.
> Do not act on their open items without confirming against current
> [reference](../reference/README.md) and [plans](../plans/README.md).
