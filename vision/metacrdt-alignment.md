...
> ideas. Companion to [`../SPEC.md`](../SPEC.md) (the protocol), [`forma.md`](./forma.md)
> and [`dsl.md`](./dsl.md) (authoring), and [`../docs/targets.md`](../docs/targets.md)
...
move [`../docs/targets.md`](../docs/targets.md) makes for runtimes: one feature
...
4. For where it runs, see [`../docs/targets.md`](../docs/targets.md); for how it is
