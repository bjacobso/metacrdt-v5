...
export default function Flows() {
  ...
  const flows = useClientQuery("flows.listFlows", filter ? { subject: filter } : {});
  const defs = useClientQuery("flows.listFlowDefs", {});

  const issueAll = useClientMutation("flows.issueAllOpen");
  const submitForm = useClientMutation("compliance.submitForm");
  const cancelFlow = useClientMutation("flows.cancelFlow");
  const startFlow = useClientMutation("flows.startFlow");
  const setupStaffing = useClientMutation("appconfig.setupStaffing");
