...
export function Meta() {
  return (
    <section className="site-section section-rule border-b border-white/10" id="meta">
      <div className="section-inner grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
        <div>
          ...
          <p className="mt-6 max-w-sm font-mono text-sm leading-6 text-amber-line">{meta.tagline}</p>
        </div>
        <AsciiScene
